...
/// <summary>
/// Splits a JsonPath expression into its constituent PathElement segments,
/// respecting bracket nesting so that array subscripts like [?(@ > 0)] are kept intact.
/// Copied from TLio.Json.Internal.JsonSplittedPath — pure string utility with no format dependency.
/// </summary>
internal class JsonSplittedPath
{
    ...
    /// Used to first select existing nodes before walking construction segments.
    /// </summary>
