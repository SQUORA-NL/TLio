...
public sealed class JsonAdapterTests
{
    ...
    public void ToIM_JsonNull_ProducesScalarNull()
    {
        ...
        var scalar = (FormatConverter.Core.Model.ScalarNode)im;
        Assert.That(scalar.Type, Is.EqualTo(FormatConverter.Core.Model.ScalarType.Null));
    ...
    public void ToIM_JsonInteger_ProducesScalarInteger()
    {
        ...
        var obj = (FormatConverter.Core.Model.ObjectNode)im;
        var scalar = (FormatConverter.Core.Model.ScalarNode)obj.Children[0];
        Assert.That(scalar.Type, Is.EqualTo(FormatConverter.Core.Model.ScalarType.Integer));
    ...
    public void ToIM_JsonDecimal_ProducesScalarDecimal()
    {
        ...
        var obj = (FormatConverter.Core.Model.ObjectNode)im;
        var scalar = (FormatConverter.Core.Model.ScalarNode)obj.Children[0];
        Assert.That(scalar.Type, Is.EqualTo(FormatConverter.Core.Model.ScalarType.Decimal));
    }
    ...
    public void ToIM_JsonBoolean_ProducesScalarBoolean()
    {
        ...
        var obj = (FormatConverter.Core.Model.ObjectNode)im;
        var scalar = (FormatConverter.Core.Model.ScalarNode)obj.Children[0];
        Assert.That(scalar.Type, Is.EqualTo(FormatConverter.Core.Model.ScalarType.Boolean));
    ...
    {
        var im = new FormatConverter.Core.Model.ScalarNode(FormatConverter.Core.Model.ScalarType.Null, null);
        var output = _adapter.FromIM(im, ConversionSettings.Empty);
    ...
    {
        var im = new FormatConverter.Core.Model.ScalarNode(FormatConverter.Core.Model.ScalarType.Boolean, "false");
        var output = _adapter.FromIM(im, ConversionSettings.Empty);
