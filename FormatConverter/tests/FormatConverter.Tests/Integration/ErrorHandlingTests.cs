...
public sealed class ErrorHandlingTests
{
    ...
    public void ScalarNode_NullValue_RequiresNullType()
    {
        Assert.Throws<ArgumentException>(
            () => new global::FormatConverter.Core.Model.ScalarNode(global::FormatConverter.Core.Model.ScalarType.String, null));
    }
    ...
    {
        Assert.DoesNotThrow(
            () => new global::FormatConverter.Core.Model.ScalarNode(global::FormatConverter.Core.Model.ScalarType.Null, null));
    }
}
