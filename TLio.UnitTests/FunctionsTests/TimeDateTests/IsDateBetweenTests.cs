...
public class IsDateBetweenTests
{
    ...
    [Test]
    public void IsDateBetween_DateInRange_ReturnsTrue()
    {
    ...
    [Test]
    public void IsDateBetween_DateBeforeRange_ReturnsFalse()
    {
        var fn = new IsDateBetween<JToken>();
        fn.SetArguments(new Arguments<JToken>
        {
            new PathValue<JToken>("$.before"),
            new PathValue<JToken>("$.start"),
            new PathValue<JToken>("$.end")
        });
        var result = fn.Execute(data, data, context);
    ...
    [Test]
    public void IsDateBetween_DateAfterRange_ReturnsFalse()
    {
        var fn = new IsDateBetween<JToken>();
        fn.SetArguments(new Arguments<JToken>
        {
            new PathValue<JToken>("$.after"),
            new PathValue<JToken>("$.start"),
            new PathValue<JToken>("$.end")
        });
        var result = fn.Execute(data, data, context);
    ...
    [Test]
    public void IsDateBetween_OnStartBoundary_ReturnsTrue()
    {
        var fn = new IsDateBetween<JToken>();
        fn.SetArguments(new Arguments<JToken>
        {
            new PathValue<JToken>("$.onStart"),
            new PathValue<JToken>("$.start"),
            new PathValue<JToken>("$.end")
        });
        var result = fn.Execute(data, data, context);
    ...
    [Test]
    public void IsDateBetween_OnEndBoundary_ReturnsTrue()
    {
        var fn = new IsDateBetween<JToken>();
        fn.SetArguments(new Arguments<JToken>
        {
            new PathValue<JToken>("$.onEnd"),
            new PathValue<JToken>("$.start"),
            new PathValue<JToken>("$.end")
        });
        var result = fn.Execute(data, data, context);
